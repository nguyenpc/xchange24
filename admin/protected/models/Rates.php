	...
	public function rules()
	{
		...
		return array(
			array('from_proc, to_proc, rate, level, min, extra_fees', 'required'),
                        array('from_proc+to_proc+level', 'application.extensions.uniqueMultiColumnValidator'),
			array('from_proc, to_proc, level, min, max, extra_fees', 'numerical', 'integerOnly'=>true),
                                                                   array('from_proc','compare', 'compareAttribute'=>'to_proc', 'operator'=>'!=',
                                                                       'message'=>'From Processor and To Processor must be different'),
                        array('min','compare', 'compareAttribute'=>'max', 'operator'=>'<'),
