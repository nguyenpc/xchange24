...
class News extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title_en, title_vi, content_en, content_vi, date', 'required'),
			array('date', 'numerical', 'integerOnly'=>true),
			array('title_en, title_vi', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title_en, title_vi, content_en, content_vi, date', 'safe', 'on'=>'search'),
		);
	}
